...
# auth_ldap (https://github.com/kvspb/nginx-auth-ldap)
HTTP_AUTH_LDAP_MODULE_PV="59ef5fd1dfc91d27e71aea7636be88302c56834a"
HTTP_AUTH_LDAP_MODULE_P="nginx-auth-ldap-${HTTP_AUTH_LDAP_MODULE_PV}"
HTTP_AUTH_LDAP_MODULE_URI="https://github.com/nyoxi/nginx-auth-ldap/archive/${HTTP_AUTH_LDAP_MODULE_PV}.tar.gz"
...
src_install() {
	...
	if use nginx_modules_http_auth_ldap; then
		...
		dodoc "${HTTP_AUTH_LDAP_MODULE_WD}"/README.md
	fi
